...
<div class="row">
	<div class="col-md-12">
		<div class="main-card mb-3 card">
			<div class="card-body">
				<h5 class="card-title">Edit megapool information <small class="form-text text-danger">All fields are mandatory</small></h5>
				
				<?php if($league_details){ ?>
					<form id="mega-pool-edit-frm" method="post" enctype="multipart/form-data">
						<input type="hidden" name="url" value="<?php echo $league_details['mega_pool_url']; ?>" >
						...
						<div class="row">
							<div class="col-sm-12 col-md-6">
								<div class="position-relative form-group">
									...
									<input name="mega_pool_title" value="<?php echo $league_details['mega_pool_title']; ?>" id="mega_pool_title" placeholder="League name" type="text" class="form-control" required="required" autocomlete="off">
								</div>
							</div>
						...
						<div class="row">
							<div class="col-sm-12 col-md-12">
								<div class="position-relative form-group">
									<img width=200 height=200 class="img-thumbnail" src="<?php echo base_url('assets/uploads/megapool_logo/'.$league_details['league_logo']) ?>">
								</div>
						...
						<div class="position-relative form-group">
							...
							<div>
								<div class="custom-radio custom-control">
									<input value="1" type="radio" id="league_status1" name="league_status" class="custom-control-input" <?php if($league_details['current_status'] == 1){ ?> checked <?php } ?>>
									<label class="custom-control-label" for="league_status1">Active</label>
								</div>
								<div class="custom-radio custom-control">
									<input value="2" type="radio" id="league_status2" name="league_status" class="custom-control-input" <?php if($league_details['current_status'] == 2){ ?> checked <?php } ?>>
									<label class="custom-control-label" for="league_status2">In-active</label>
								</div>
								<div class="custom-radio custom-control">
									<input value="3" type="radio" id="league_status3" name="league_status" class="custom-control-input" <?php if($league_details['current_status'] == 3){ ?> checked <?php } ?>>
