					...
					<div class="position-relative form-group">
						...
						<div>
							<div class="custom-radio custom-control">
								<input value="1" type="radio" id="league_type1" name="league_type" class="custom-control-input" checked="checked">
							...
							<div class="custom-radio custom-control">
								<input value="2" type="radio" id="league_type2" name="league_type" class="custom-control-input">
								<label class="custom-control-label" for="league_type2">Single Play [<small class="text-danger">Player will get points</small>]</label>
							</div>
							<div class="custom-radio custom-control">
								<input value="3" type="radio" id="league_type3" name="league_type" class="custom-control-input">
