	...
	<div class="col-md-12">
		<div class="main-card mb-3 card">
			<div class="card-body">
				...
				<form id="update-profile" action="<?php echo base_url('cms/about-us'); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="position-relative form-group">
						<label for="page_content" class="">Write something About Page</label>
					...
					<a href="<?php echo  base_url('cms/about-us'); ?>">
