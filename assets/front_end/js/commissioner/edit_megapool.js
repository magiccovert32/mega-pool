...
$('#edit-mega-pool').on('click', function(){
    $('#edit-mega-pool').attr('disabled','disabled');
    ...
    if(sport_id == ''){
        error = 1;
        error_msg.push('Enter select sport.');
    }
        ...
        $.ajax({
            ...
            success: function (response) {
                if(response.status == 1){
                    ...
                    $('#edit-mega-pool').removeAttr('disabled');
